...
void jit_compile_and_launch(
    const std::string& expr_code,
    ...
    // Compile
    nvrtcProgram prog;
    NVRTC_CHECK(nvrtcCreateProgram(&prog, kernel.c_str(), "user_kernel.cu", 0, nullptr, nullptr));
    ...
    CU_CHECK(cuLaunchKernel(kernel_func,
                            blocks, 1, 1,
                            threads, 1, 1,
                            0, 0, args, nullptr));
